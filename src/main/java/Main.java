    ...
    static void bill(int rn,int rtype)
    {
        ...
        switch(rtype)
        {
            case 1:
                ...
                System.out.println("-------------------------");
                for(Food obb: hotel_ob.luxury_doublerrom[rn].getFood())
                {
                    amount+=obb.price;
            ...
            case 3:amount+=2200;
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb: hotel_ob.luxury_singleerrom[rn].getFood())
                {
                    amount+=obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
            ...
            case 4:amount+=1200;
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb: hotel_ob.deluxe_singleerrom[rn].getFood())
                {
                    amount+=obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
    ...
    static void order(int rn,int rtype)
    {
        ...
        try{
            ...
            do
            {
                ...
                switch(rtype){
                    case 1: hotel_ob.luxury_doublerrom[rn].getFood().add(new Food(i,q));
                        break;
                    case 2: hotel_ob.deluxe_doublerrom[rn].getFood().add(new Food(i,q));
                        break;
                    case 3: hotel_ob.luxury_singleerrom[rn].getFood().add(new Food(i,q));
                        break;
                    case 4: hotel_ob.deluxe_singleerrom[rn].getFood().add(new Food(i,q));
                        break;
                }
